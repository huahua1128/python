...
import unittest
from ddt import ddt, data, unpack      # pip install  ddt
from  zgh.unittest_test.zuoye_0105.math_class_method import MathMethod
from  zgh.unittest_test.zuoye_0105.do_excel import DoExcel
from  zgh.unittest_test.zuoye_0105.my_log import MyLog
...
class TestMathClass(unittest.TestCase):  #继承TestCase
    ...
    def  setUp(self):
        self.t = DoExcel('method_message.xlsx', 'add')  #这行也可以放到类外面，不用self.调用时也不需要self.
