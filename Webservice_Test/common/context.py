...
class Context:  # 上下文类，数据的准备和记录
    mobile = config.get_value("data", "mobile")
    user_id = config.get_value("data", "user_id")
...
if __name__ == '__main__':
    ...
    # s = '{"verify_code": "${verify_code}", "user_id": "${user_id}", "mobile": "${mobile}", "channel_id": "2","pwd": "huahua123456", "ip": "172.28.78.9"}'
    # s = replace(s)
    # print(type(s), s)
